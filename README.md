...
Key highlights of the study:<br>

Descriptive Analysis: Understanding review patterns, sentiment distribution, and feature extraction.<br>
Text Preprocessing: Tokenization, stopword removal, stemming, lemmatization, and vectorization (TF-IDF).<br>
Machine Learning Models: Naïve Bayes, Support Vector Machines (SVM), and Linear Regression to predict review scores.<br>
...
Positive Reviews: 72.5%<br>
Negative Reviews: 15.2%<br>
Neutral Reviews: 12.3%<br>
<br>
Topic Modeling (LDA extracted top topics from the reviews):<br>
<br>
Dog Food Reviews: ["dog", "treats", "love", "like"]<br>
Beverages: ["tea", "coffee", "flavor", "cup"]<br>
Snacks & Chips: ["chips", "salt", "crunchy", "spicy"]<br>
Amazon Service & Pricing: ["order", "price", "box", "delivery"]<br>
<br>
Model Performance
<br>
Linear Regression RMSE: 1.0936<br>
